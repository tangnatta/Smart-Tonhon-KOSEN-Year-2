...
def get_images_with_request_headers():
    del params["ijn"]
    # parameter that indicate the original media type
...
def get_suggested_search_data():
    ...
    matched_images = "".join(re.findall(
        r"AF_initDataCallback\(({key: 'ds:1'.*?)\);</script>", str(all_script_tags)))
    ...
    suggested_search_thumbnails = ",".join(re.findall(
        r'{key(.*?)\[null,\"Size\"', matched_images_data_json))

    # https://regex101.com/r/MyNLUk/1
    suggested_search_thumbnail_encoded = re.findall(
        r'\"(https:\/\/encrypted.*?)\"', suggested_search_thumbnails)
...
def get_original_images():
    ...
    # print("matched_images_data_fix", matched_images_data_fix)

    matched_images_data_json = json.loads(matched_images_data_fix)

    # print("matched_images_data_json", matched_images_data_json)
    ...
    # print("matched_google_images_thumbnails", matched_google_images_thumbnails)
    ...
    # print("removed_matched_google_images_thumbnails",
    ...
    # print("full_res_images", full_res_images)
